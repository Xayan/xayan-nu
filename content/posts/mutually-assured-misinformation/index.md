...
# Indexing
recommended: true
categories: ["Sociology", "Poli-Sci", "Epistemology"]
tags: [
  "europe", "eu", "poland", "academia",
  "political theory", "migration", "propaganda", "social engineering", "terrorism",
  "liberal universalism", "sovereignty", "ideology", "free speech", "censorship"
]
---
...
> 3. **Offering training to journalists**: [...] Training can also help journalists to use data and research effectively in their reporting, including how to interpret and analyse migration data and how to explain trends and patterns.
...
Is **DSA** (Digital Services Act) just a fever dream, then? I think not, as we can read on the page [The Code of Conduct on Disinformation](https://digital-strategy.ec.europa.eu/en/library/code-conduct-disinformation):
...
In this case, *"false information"* stems the fact that the perpetrator isn't a *muslim male immigrant* - but he happens to be a **child of immigrants**. And... well, I've looked into it, and this is what it says [on Wikipedia](https://en.wikipedia.org/wiki/2024_Southport_stabbings):
...
Interestingly, it seems like the police wanted to prevent this, but were [advised against it](https://www.bbc.com/news/articles/c8d491mqqq5o):
...
> 1) media and information literacy; 2) communication-based responses; and 3) contact-based responses.
...
The numbers come from a parliamentary inquiry, as reported by [WELT](https://www.welt.de/politik/deutschland/plus256407930/Gewalt-an-Schulen-Schlagen-treten-wuergen-Wie-brutal-es-im-Land-wirklich-zugeht.html) (or here [without paywall](https://archive.is/auzGZ)). Translated to English:
...
Overrepresentation of foreigners from another inquiry, also [reported by WELT](https://www.welt.de/politik/deutschland/plus256340494/Auswertung-Diese-Nationalitaeten-fallen-bei-Jugendkriminalitaet-besonders-auf.html) (also [without paywall](https://archive.is/j7EuA)):
...
And let's not forget about classification issues of German crime data, hiding the true scale of the problem. Only now it's starting to change, as [North Rhine-Westphalia introduced tracking of specific nationalities](https://migrando.de/en/news/general/nrw-erfasst-doppelte-staatsbuergerschaft-in-kriminalstatistik-werden-andere-bundeslaender-folgen/):
...
I think that the best way to achieve a permanent change is through the reform of academic institutions, making them truly independent and transparent. I have described this in a little more detail in my previous post about [liberal universalism](/posts/liberal-universalism/#treatment).
...
Catch me [on X](https://x.com/@xayan__), if you'd like to discuss something in private. Or write in the comments how your country is doing.
